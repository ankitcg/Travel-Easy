  ...
  return (
    <div className="flex ">
      <div className="max-w-full mx-16 my-20 justify-between ">
        <h1 className="text-2xl font-semibold mx-4">Edit Car Details</h1>
        <div className="flex justify-between ">
          ...
          <div className="my-4 mx-8">
              ...
              <button className="bg-red-500 h-8 w-28 rounded-3xl mx-10">Delete</button>
              <button className="bg-blue-500 h-8 w-28 rounded-3xl mx-10">Save</button>
            </div>
        </div>
      </div>
    </div>
